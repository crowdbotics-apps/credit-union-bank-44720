"""
Django settings for credit_union_bank_44720 project.
...
ROOT_URLCONF = 'credit_union_bank_44720.urls'
...
WSGI_APPLICATION = 'credit_union_bank_44720.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "credit_union_bank_44720 API",
    "DESCRIPTION": "API documentation for credit_union_bank_44720 App",
    "VERSION": "v1",
}
